	...
	public function renderForm()
	{
		$fields_form = array(
			'form' => array(
				...
				'description' => $this->l('Отображает в заголовке ваш телефон. Первый номер телефона - основной и будет отображаться вверху сайта. Все остальные номера телефонов (НОМЕР ТЕЛЕФОНА 2, НОМЕР ТЕЛЕФОНА 3, E-mail) и email - в выпадающем списке.').'<br/>'.

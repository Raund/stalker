...
class Blockcontactinfos extends Module
{
	protected static $contact_fields = array(
		...
		'BLOCKCONTACTINFOS_COMPANY7',
		'BLOCKCONTACTINFOS_ADDRESS7',
		'BLOCKCONTACTINFOS_HEADQUARTERS7',
		'BLOCKCONTACTINFOS_COMPANY8',
		'BLOCKCONTACTINFOS_ADDRESS8',
		'BLOCKCONTACTINFOS_HEADQUARTERS8',
		'BLOCKCONTACTINFOS_COMPANY9',
		'BLOCKCONTACTINFOS_ADDRESS9',
		'BLOCKCONTACTINFOS_HEADQUARTERS9',
		...
		'BLOCKCONTACTINFOS_PHONE7',
		'BLOCKCONTACTINFOS_PHONE7',
		'BLOCKCONTACTINFOS_PHONE7',
		'BLOCKCONTACTINFOS_PHONE8',
		'BLOCKCONTACTINFOS_PHONE8',
		'BLOCKCONTACTINFOS_PHONE8',
		'BLOCKCONTACTINFOS_PHONE9',
		'BLOCKCONTACTINFOS_PHONE9',
		'BLOCKCONTACTINFOS_PHONE9',
		...
		'BLOCKCONTACTINFOS_EMAIL7',
		'BLOCKCONTACTINFOS_EMAIL8',
		'BLOCKCONTACTINFOS_EMAIL9'
	);
	...
	public function install()
	{
		...
		Configuration::updateValue('BLOCKCONTACTINFOS_COMPANY7', Configuration::get('PS_SHOP_NAME7'));
		Configuration::updateValue('BLOCKCONTACTINFOS_ADDRESS7', trim(preg_replace('/ +/', ' ', Configuration::get('PS_SHOP_ADDR7').' '.Configuration::get('PS_SHOP_ADDR8')."\n".Configuration::get('PS_SHOP_CODE7').' '.Configuration::get('PS_SHOP_CITY7')."\n".Country::getNameById(Configuration::get('PS_LANG_DEFAULT7'), Configuration::get('PS_SHOP_COUNTRY_ID7')))));
		Configuration::updateValue('BLOCKCONTACTINFOS_HEADQUARTERS7', Configuration::get('PS_SHOP_HEADQUARTERS7'));
		Configuration::updateValue('BLOCKCONTACTINFOS_COMPANY8', Configuration::get('PS_SHOP_NAME8'));
		Configuration::updateValue('BLOCKCONTACTINFOS_ADDRESS8', trim(preg_replace('/ +/', ' ', Configuration::get('PS_SHOP_ADDR8').' '.Configuration::get('PS_SHOP_ADDR9')."\n".Configuration::get('PS_SHOP_CODE8').' '.Configuration::get('PS_SHOP_CITY8')."\n".Country::getNameById(Configuration::get('PS_LANG_DEFAULT8'), Configuration::get('PS_SHOP_COUNTRY_ID8')))));
		Configuration::updateValue('BLOCKCONTACTINFOS_HEADQUARTERS8', Configuration::get('PS_SHOP_HEADQUARTERS8'));
		Configuration::updateValue('BLOCKCONTACTINFOS_COMPANY9', Configuration::get('PS_SHOP_NAME9'));
		Configuration::updateValue('BLOCKCONTACTINFOS_ADDRESS9', trim(preg_replace('/ +/', ' ', Configuration::get('PS_SHOP_ADDR9').' '.Configuration::get('PS_SHOP_ADDR10')."\n".Configuration::get('PS_SHOP_CODE9').' '.Configuration::get('PS_SHOP_CITY9')."\n".Country::getNameById(Configuration::get('PS_LANG_DEFAULT9'), Configuration::get('PS_SHOP_COUNTRY_ID9')))));
		Configuration::updateValue('BLOCKCONTACTINFOS_HEADQUARTERS9', Configuration::get('PS_SHOP_HEADQUARTERS9'));
		...
		Configuration::updateValue('BLOCKCONTACTINFOS_PHONE7', Configuration::get('PS_SHOP_PHONE7'));
		Configuration::updateValue('BLOCKCONTACTINFOS_PHONE8', Configuration::get('PS_SHOP_PHONE8'));
		Configuration::updateValue('BLOCKCONTACTINFOS_PHONE9', Configuration::get('PS_SHOP_PHONE9'));
		...
		Configuration::updateValue('BLOCKCONTACTINFOS_EMAIL7', Configuration::get('PS_SHOP_EMAIL7'));
		Configuration::updateValue('BLOCKCONTACTINFOS_EMAIL8', Configuration::get('PS_SHOP_EMAIL8'));
		Configuration::updateValue('BLOCKCONTACTINFOS_EMAIL9', Configuration::get('PS_SHOP_EMAIL9'));
		...
		$fields_form = array(
			'form' => array(
				...
				'input' => array(
					...
					array(
						'type' => 'text',
						'label' => $this->l('Город 3 (рус)'),
						'name' => 'BLOCKCONTACTINFOS_COMPANY7',
					),
					array(
						'type' => 'textarea',
						'label' => $this->l('Улица 3 (рус)'),
						'name' => 'BLOCKCONTACTINFOS_ADDRESS7',
					),
					/* array(
                         'type' => 'textarea',
                         'label' => $this->l('Корпус 3/ офис 3 (рус)'),
                         'name' => 'BLOCKCONTACTINFOS_HEADQUARTERS7',
                     ),*/
					array(
						'type' => 'text',
					...
					array(
						'type' => 'text',
						'label' => $this->l('Місто 3 (укр)'),
						'name' => 'BLOCKCONTACTINFOS_COMPANY8',
					),
					array(
						'type' => 'textarea',
						'label' => $this->l('Вулиця 3 (укр)'),
						'name' => 'BLOCKCONTACTINFOS_ADDRESS8',
					),
					/*array(
                        'type' => 'textarea',
                        'label' => $this->l('Корпус 3/ офіс 3 (укр)'),
                        'name' => 'BLOCKCONTACTINFOS_HEADQUARTERS8',
                    ),*/
					array(
						'type' => 'text',
					...
					array(
						'type' => 'text',
						'label' => $this->l('City 3 (en)'),
						'name' => 'BLOCKCONTACTINFOS_COMPANY9',
					),
					array(
						'type' => 'textarea',
						'label' => $this->l('Street 3 (en)'),
						'name' => 'BLOCKCONTACTINFOS_ADDRESS9',
					),
					/*array(
                        'type' => 'textarea',
                        'label' => $this->l('Office 3 (en)'),
                        'name' => 'BLOCKCONTACTINFOS_HEADQUARTERS9',
                    ),*/
					array(
						'type' => 'text',
					...
					array(
						'type' => 'text',
						'label' => $this->l('Номер телефона 1 для города 3'),
						'name' => 'BLOCKCONTACTINFOS_PHONE7',
					),
					array(
						'type' => 'text',
						'label' => $this->l('Номер телефона 2 для города 3'),
						'name' => 'BLOCKCONTACTINFOS_PHONE8',
					),
					array(
						'type' => 'text',
						'label' => $this->l('Номер телефона 3 для города 3'),
						'name' => 'BLOCKCONTACTINFOS_PHONE9',
					),
					array(
						'type' => 'text',
						'label' => $this->l('Email 1 для для города 3'),
						'name' => 'BLOCKCONTACTINFOS_EMAIL7',
					),
					array(
						'type' => 'text',
						'label' => $this->l('Email 2 для для города 3'),
						'name' => 'BLOCKCONTACTINFOS_EMAIL8',
					),
					array(
						'type' => 'text',
					...
					array(
						'type' => 'text',
						'label' => $this->l('Карта доезда для города 3'),
						'name' => 'BLOCKCONTACTINFOS_EMAIL9',
					),
				),
				'submit' => array(
					'title' => $this->l('Save')

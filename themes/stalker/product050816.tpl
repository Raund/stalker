...
<div class="item-wrap" itemtype="https://schema.org/Product">
    ...
    <div class="container">
		...
		{/if}
		<!-- left infos-->
<div class="clearfix"><!--открываю свою распорку-->
        ...
        <div class="col-md-5 item-description">
            ...
            {if isset($product) && $product->description}
                <!-- More info -->
                    ...
                    <!-- full description -->
                    <div  class="rte">{$product->description|truncate:375:'...'}</div>
